...
if ($result->num_rows > 0){
    $processes = $result->fetch_all(MYSQL_ASSOC);
} else {
    echo "NO RESULT!!!";
    return;
}
...
<svg id="cvs" width="100%" height="900"  viewBox="0 0 1290 900" preserveAspectRatio="xMinYMin meet">
<!--<svg id="cvs" width="100%" height="1000"  >-->
	<defs>
